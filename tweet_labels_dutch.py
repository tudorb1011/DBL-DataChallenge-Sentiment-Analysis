...
import sqlite3
test_tweets_amount = 100  # should be 100, but can make it smaller to test the script
...
label_df.to_csv('labels_testset_dutch.csv', index=False)
